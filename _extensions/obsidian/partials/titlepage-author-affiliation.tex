...
% Author and affiliation rendering. Author styles: none | plain |
% plain-with-and | superscript | superscript-with-and | two-column |
% author-address. Affiliation styles: none | numbered-list |
% numbered-list-with-correspondence. The active styles are recorded by
% filters/titlepage.lua. Uses the Quarto normalised author schema
% (by-author / by-affiliation) so structured authors with ORCID,
% affiliations and email render correctly.
