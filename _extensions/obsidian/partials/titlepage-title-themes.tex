...
% Title and subtitle rendering, one block definition per active
% title-style (plain | colorbox | doublelinewide | doublelinetight).
% The active style is recorded by filters/titlepage.lua in
% titlepage-style-code.title.<style>.

\newcommand{\titleandsubtitle}{%
% Title and subtitle. Sans display face (Montserrat) per the house
% heading system; body elements stay serif.
$if(title)$
{\sffamily$if(titlepage-theme.title-fontsize)$\fontsize{$titlepage-theme.title-fontsize$}{$titlepage-theme.title-spacing$}\selectfont
...
\fcolorbox{$if(titlepage-theme.title-colorbox-bordercolor)$$titlepage-theme.title-colorbox-bordercolor$$else$black$endif$}{$if(titlepage-theme.title-colorbox-fill)$$titlepage-theme.title-colorbox-fill$$else$white$endif$}{%
